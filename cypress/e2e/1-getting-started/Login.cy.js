...
describe('example Login to app', () => {
  ...
  describe('Prueba de inicio de sesión automático', () => {
    it('Inicia sesión automáticamente con credenciales válidas y realiza test de aptitudes, para despues comprobar resultados', () => {
      ...
      cy.get(':nth-child(7) > form > .question > #options > :nth-child(2) > .checkmark').click().wait(1000)
      cy.get(':nth-child(8) > form > .question > #options > :nth-child(1) > .checkmark').click().wait(1000)
      cy.get(':nth-child(9) > form > .question > #options > :nth-child(4) > .checkmark').click().wait(1000)
      cy.get(':nth-child(10) > form > .question > #options > :nth-child(4) > .checkmark').click().wait(1000)
      cy.get(':nth-child(11) > form > .question > #options > :nth-child(1) > .checkmark').click().wait(1000)
      cy.get(':nth-child(12) > form > .question > #options > :nth-child(1) > .checkmark').click().wait(1000)
      cy.get(':nth-child(13) > form > .question > #options > :nth-child(2) > .checkmark').click().wait(1000)
      cy.get(':nth-child(14) > form > .question > #options > :nth-child(4) > .checkmark').click().wait(1000)
      cy.get(':nth-child(15) > form > .question > #options > :nth-child(3) > .checkmark').click().wait(1000)
      cy.get(':nth-child(16) > form > .question > #options > :nth-child(1) > .checkmark').click().wait(1000)
