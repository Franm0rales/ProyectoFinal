...
export default function GaleriaAdmin() {
  return (
    <>
      <div className="container" id="cursor">
        <h1 className="text-center pt-4">Galeria</h1>
        <div className="d-flex mb-3 mt-4 ml-4 d-flex  flex-wrap d-grip gap-3 ">
          <div>
            <img
              className="card col-3"
              src="https://picsum.photos/id/112/300/300"
              data-image-hd="https://picsum.photos/id/112/600/600"
              alt="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime accusamus officiis dignissimos doloribus consectetur harum eos sapiente optio aut minima."
            />
          </div>
          <div>
            <img
              className="card col-3"
              src="https://picsum.photos/id/155/300/300"
              data-image-hd="https://picsum.photos/id/155/600/600"
          ...
          <div>
            <img
              ...
              data-image-hd="https://picsum.photos/id/11/600/600"
          ...
          <div>
            <img
              className="card col-3"
              src="https://picsum.photos/id/434/300/300"
              data-image-hd="https://picsum.photos/id/434/600/600"
          ...
          <div>
            <img
              ...
              data-image-hd="https://picsum.photos/id/101/600/600"
          ...
          <div>
            <img
              className="card col-3"
              src="https://picsum.photos/id/343/300/300"
