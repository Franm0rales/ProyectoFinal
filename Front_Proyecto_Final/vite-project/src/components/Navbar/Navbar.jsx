            ...
            <div className="col-lg-7 d-flex justify-content-center justify-content-lg-end">
              <div className="contenido text-center">
                ...
                <div className="navbar-expand-lg navbar-light bg-transparent">
                  <button className="navbar-toggler bg-light" type="button" data-toggle="collapse" data-target="#navegacion">
                  ...
                  <div className="collapse navbar-collapse " id="navegacion">
                    <nav className="navegacion d-flex flex-column flex-lg-row text-center ">
                      ...
                      <a href="#" className="nav-link px-2">Nosotros</a>
                      <a href="#" className="nav-link px-2">Quedadas</a>
                      <a href="#" className="nav-link px-2">Login</a>
                      <a href="#" className="nav-link pr-0 px-2">Contacto</a>
                    </nav>
                  </div>
                </div>
              </div>
