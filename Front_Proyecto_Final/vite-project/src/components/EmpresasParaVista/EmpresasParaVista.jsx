export default function EmpresasParaVista() {
  return (
    <div class="container">
      <div class="col-md-12">
        <div class="tarjeta b-1 hover-shadow mb-20">
          <div class="media tarjeta-body">
            ...
            <div class="media-right text-right d-none d-md-block">
              <p class="fs-14 text-fade mb-12">
                <i class="fa fa-map-marker pr-1"></i> Menlo Park, CA
              </p>
              <span class="text-fade">
                <i class="fa fa-money pr-1"></i> $60 per hour
              </span>
            </div>
          </div>
          <footer class="tarjeta-footer flexbox align-items-center">
            <div>
              <strong>Applied on:</strong>
              <span>21 Jan, 2017</span>
            </div>
            <div class="tarjeta-hover-show">
        ...
        <div class="tarjeta b-1 hover-shadow mb-20">
          <div class="media tarjeta-body">
            ...
            <div class="media-right text-right d-none d-md-block">
              <p class="fs-14 text-fade mb-12">
                <i class="fa fa-map-marker pr-1"></i> Fairfield, IA
              </p>
              <span class="text-fade">
                <i class="fa fa-money pr-1"></i> $45 per hour
              </span>
            </div>
          </div>
        ...
        <div class="tarjeta b-1 hover-shadow mb-20">
          <div class="media tarjeta-body">
            ...
            <div class="media-right text-right d-none d-md-block">
              <p class="fs-14 text-fade mb-12">
                <i class="fa fa-map-marker pr-1"></i> Seattle, WA
              </p>
              <span class="text-fade">
                <i class="fa fa-money pr-1"></i> $40 per hour
              </span>
            </div>
          </div>
        ...
        <div class="tarjeta b-1 hover-shadow mb-20">
          <div class="media tarjeta-body">
            ...
            <div class="media-right text-right d-none d-md-block">
              <p class="fs-14 text-fade mb-12">
                <i class="fa fa-map-marker pr-1"></i> Fremont, CA
              </p>
              <span class="text-fade">
                <i class="fa fa-money pr-1"></i> $55 per hour
              </span>
            </div>
          </div>
